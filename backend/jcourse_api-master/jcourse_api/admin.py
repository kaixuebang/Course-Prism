...
class TeamMemberAdmin(ImportExportModelAdmin):
    list_display = ('id', 'name', 'role', 'class_name', 'has_avatar', 'order', 'is_active', 'created_at')
    list_filter = ('role', 'class_name', 'is_active', 'created_at')
    search_fields = ('name', 'role', 'class_name', 'description', 'github', 'qq', 'wechat', 'email')
...
class ContributorAdmin(ImportExportModelAdmin):
    list_display = ('id', 'name', 'class_name', 'contribution_type', 'contributions', 'is_active', 'created_at')
    list_filter = ('contribution_type', 'class_name', 'is_active', 'created_at')
    search_fields = ('name', 'class_name', 'description')
    list_editable = ('contributions', 'is_active')
